...
$csrfToken = rex_csrf_token::factory('project_manager_plus_server_details');
...
$sel_editor->addDBSqlOptions("select domain as name, domain as id FROM rex_project_manager_plus_domain ORDER BY domain");

$formElements = [];
$n = [];
$n['label'] = '<label for="rex-id-editor">' .$this->i18n('project_manager_plus_server_select_project')  . '</label>';
...
$content = '
  ...
  <input type="hidden" name="page" value="project_manager_plus/server/projects" />
...
if ($domain) {
    ...
    if ((isset($raw)) && (is_array($raw))) {
        ...
        if ($item['cms'] == 4) {
            ...
            if ($item['status'] == "1") {
                $output .= '<tr><td>Projekt Manager Client Abruf</td><td><span class="hidden">1</span><span class="rex-icon fa-check text-success" title="'.$this->i18n('project_manager_plus_server_status_code_1').'"></span> '.$this->i18n('project_manager_plus_server_status_code_1').'</td></tr>';
            } elseif ($item['status'] == "0") {
                $output .= '<tr><td>Projekt Manager Client Abruf</td><td><span class="hidden">2</span><span class="rex-icon fa-question text-warning" title="'.$this->i18n('project_manager_plus_server_status_code_0').'"></span> '.$this->i18n('project_manager_plus_server_status_code_0').'</td></tr>';
            } elseif ($item['status'] == "-1") {
                $output .= '<tr><td>Projekt Manager Client Abruf</td><td><span class="hidden">3</span><span class="rex-icon fa-exclamation-triangle text-danger" title="'.$this->i18n('project_manager_plus_server_status_code_minus_1').'"></span> '.$this->i18n('project_manager_plus_server_status_code_minus_1').'</td></tr>';
            } elseif ($item['status'] == "2") {
                $output .= '<tr><td>Projekt Manager Client Abruf</td><td><span class="hidden">3</span><span class="rex-icon fa-arrow-right text-danger" title="'.$this->i18n('project_manager_plus_server_status_code_2').'"></span> '.$this->i18n('project_manager_plus_server_status_code_2').'</td></tr>';
            }
        ...
        if ($item['cms'] == 5) {
            ...
            if ($item['maintenance'] == "1") {
                $output .= '<tr><td>Wartungsvertrag</td><td><span class="hidden">1</span><span class="rex-icon fa-file-text-o text-success" title="'.$this->i18n('project_manager_plus_server_maintenance_1').'"></span> '.$this->i18n('project_manager_plus_server_maintenance_1').'</td></tr>';
            } elseif ($item['maintenance'] == "0") {
                $output .= '<tr><td>Wartungsvertrag</td><td><span class="hidden">2</span><span class="rex-icon fa-file-text-o text-danger" title="'.$this->i18n('project_manager_plus_server_maintenance_0').'"></span> '.$this->i18n('project_manager_plus_server_maintenance_0').'</td></tr>';
            } elseif ($item['maintenance'] == "") {
                $output .= '<tr><td>Wartungsvertrag</td><td><span class="hidden">3</span><span class="rex-icon fa-question text-warning" title="'.$this->i18n('project_manager_plus_server_maintenance_2').'"></span> '.$this->i18n('project_manager_plus_server_maintenance_2').'</td></tr>';
            }
            ...
            $updates = "(".$i."&nbsp;". $this->i18n('project_manager_plus_server_updates') ." ".$this->i18n('updates_necessary').")";
            $fragment = new rex_fragment();
            $fragment->setVar('class', 'info', false);
            ...
            if (!is_null($logfile)) {
                ...
                if ($item['status'] == "1") {
                    ...
                    $icon = ' <i class="rex-icon fa-question" title="'.$this->i18n('project_manager_plus_server_status_code_0').'"></i>';
                } elseif ($item['status'] == "-1") {
                    $icon = ' <i class="rex-icon fa-exclamation-triangle" title="'.$this->i18n('project_manager_plus_server_status_code_minus_1').'"></i>';
                } elseif ($item['status'] == "2") {
                    $icon = ' <i class="rex-icon fa-arrow-right" title="'.$this->i18n('project_manager_plus_server_status_code_2').'"></i>';
                }
        ...
        $content_ep = '';
        $content_ep .= rex_extension::registerPoint(new rex_extension_point('project_manager_plus_SERVER_DETAIL_HOOK', '', [
          'domain' => $domain,
          'domain_id' => $domain_id
        ]));
