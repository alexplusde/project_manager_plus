...
if (rex_post('btn_save', 'string') != '') {
  ...
  $message = $this->i18n('project_manager_plus_server_config_saved_successful');
}
...
$formElements = [];
$n = [];
$n['label'] = '<h3>'.$this->i18n('project_manager_plus_server_min_headline').'</h3>';
$n['field'] = '';
$formElements[] = $n;

// PHP MIN
$n = [];
$n['label'] = '<label for="php_min">' . $this->i18n('project_manager_plus_server_php_min') . '</label>';
...
$formElements = [];
$n = [];
$n['label'] = '<label for="cms_4_min">' . $this->i18n('project_manager_plus_server_cms_4_min') . '</label>';
$select = new rex_select();
...
$formElements = [];
$n = [];
$n['label'] = '<label for="cms_min">' . $this->i18n('project_manager_plus_server_cms_min') . '</label>';
$select = new rex_select();
...
$formElements = [];
$n = [];
$n['label'] = '<h3>'.$this->i18n('project_manager_plus_server_configuration').'</h3>';
$n['field'] = '';
$formElements[] = $n;
...
$formElements = [];
$n = [];
$n['label'] = '<label for="skip-addon">' . $this->i18n('project_manager_plus_server_skip_addon') . '</label>';
$n['field'] = '<input class="form-control" type="text" id="skip_addon" name="config[skip_addon]" value="' . $this->getConfig('skip_addon') . '" data-role="tagsinput"/>
		 					 <p class="help-block">' . $this->i18n('project_manager_plus_server_skip_addon_notice') . '</p>';
$formElements[] = $n;
...
$formElements = [];
$n = [];
$n['label'] = '<label for="skip-addon-version">' . $this->i18n('project_manager_plus_server_skip_addon_version') . '</label>';
$n['field'] = '<input class="form-control" type="text" id="skip_addon_version" name="config[skip_addon_version]" value="' . $this->getConfig('skip_addon_version') . '" data-role="tagsinput"/>
							 <p class="help-block">' . $this->i18n('project_manager_plus_server_skip_addon_version_notice') . '</p>';
$formElements[] = $n;
...
$fragment->setVar('title', $this->i18n('project_manager_plus_server_title'), false);
